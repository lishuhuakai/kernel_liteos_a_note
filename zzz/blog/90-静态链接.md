...
本篇将通过一个完整的小工程来阐述ELF编译，链接过程，并分析 `.o` 和bin文件中各区，符号表之间的关系。从一个崭新的视角去看中间过程。
...
[ 0]             NULL     00000000000000  00000000       0000000000000000  0000000000000000           0     0     0
[ 1] .text       PROGBITS 00000000000000  00000040       000000000000007b  0000000000000000  AX       0     0     1
[ 2] .rela .text RELA     00000000000000  00000c80       0000000000000108  0000000000000018   I      19     1     8
[ 3] .data       PROGBITS 00000000000000  000000bb       0000000000000000  0000000000000000  WA       0     0     1
[ 4] .bss        NOBITS   00000000000000  000000bb       0000000000000000  0000000000000000  WA       0     0     1
[ 5] .rodata     PROGBITS 00000000000000  000000c0       000000000000007d  0000000000000000   A       0     0     8
       ......
root@5e3abe332c5a:/home/docker/test4harmony/54# readelf -s ./obj/main.o
...
* 剩下的`g_str`，`printf`，`func_int`，...。，都是需要外部提供，并未在本文件中定义的符号 `(Ndx = UND ， Type = NOTYPE)`，至于怎么顺藤摸瓜找到这些符号那我不管， `.o` 文件是独立存在，它只是告诉你我用了哪些东西，但我也不知道在哪里。
...
root@5e3abe332c5a:/home/docker/test4harmony/54# readelf -S ./obj/part.o
  [ 1] .text      PROGBITS        000000000  00000040  00000078  0000000000000000  AX       0     0     1
  [ 2] .rela .text RELA           000000000  00000cf0  000000c0  0000000000000018   I      21     1     8
  [ 3] .data      PROGBITS        000000000  000000b8  00000004  0000000000000000  WA       0     0     4
  [ 4] .bss       NOBITS          000000000  000000bc  00000000  0000000000000000  WA       0     0     1
  [ 5] .rodata    PROGBITS        000000000  000000c0  00000045  0000000000000000   A       0     0     8
  [ 6] .data .rel .local PROGBITS 000000000  00000108  00000008  0000000000000000  WA       0     0     8
       ......
root@5e3abe332c5a:/home/docker/test4harmony/54# readelf -s ./obj/part.o # 符号表信息
...
[Nr] Name        Type       Address   Offset   Size     EntSize          Flags  Link  Info  Align
       ......
[16] .text       PROGBITS  000001060  00001060 0000255  0000000000000000  AX       0     0     16
[17] .fini       PROGBITS  0000012b8  000012b8 000000d  0000000000000000  AX       0     0     4
[18] .rodata     PROGBITS  000002000  00002000 00000cd  0000000000000000   A       0     0     8       
       ......
[25] .data       PROGBITS  0000004000 00003000 0000020  0000000000000000  WA       0     0     8
[26] .bss        NOBITS    0000004020 00003020 0000008  0000000000000000  WA       0     0     1       
root@5e3abe332c5a:/home/docker/test4harmony/54# readelf -s ./bin/weharmony 
...
* 涉及对象有哪些 `Type = OBJECT` g_int，g_str，....它将这些数据统一归到了25区。
  ...
  是不是和 `part.o` 一样也被放在了`.rodata`区，再反查 18区，果然发了 `main.c` 和 `part.c` 的数据都放在了这里。
